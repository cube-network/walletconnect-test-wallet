...
export const SUPPORTED_CHAINS: IChainData[] = [
  ...
  {
    name: "CubeChain Mainnet Network",
    short_name: "Cube",
    chain: "Cube",
    network: "mainnet",
    chain_id: 1818,
    network_id: 1818,
    rpc_url: "https://http-mainnet.cube.network",
    native_currency: {
      symbol: "CUBE",
      name: "CubeChain native token",
      decimals: "18",
      contractAddress: "",
      balance: "",
    },
  ...
  {
    name: "CubeChain Testnet Network",
    short_name: "CubeTest",
    chain: "CubeTest",
    network: "testnet",
    chain_id: 1819,
    network_id: 1819,
    rpc_url: "https://http-testnet.cube.network",
    native_currency: {
      symbol: "CUBET",
      name: "CubeChain Testnet native token",
      decimals: "18",
      contractAddress: "",
      balance: "",
    },
